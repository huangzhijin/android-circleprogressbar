...
public class MainActivity extends AppCompatActivity {
    ...
    private CircleProgressBar mCustomProgressBar7;
...
//        mCustomProgressBar5 = (CircleProgressBar) findViewById(R.id.custom_progress5);
        ...
        mCustomProgressBar7 = (CircleProgressBar) findViewById(R.id.custom_progress7);
    }
...
//                mCustomProgressBar5.setProgress(progress);
                ...
                mCustomProgressBar7.setProgress(progress);
            }
        });
...
//        animator.setRepeatCount(0);
        ...
        animator.start();
//        mCustomProgressBar7.setProgress(80);
    }
